...
* **Change**: Multi-cluster, multi-region cloud (AWS/GCP), and edge sites use `schema.#Topology` and recursive `schema.#Location` blocks (see [`docs/topology.md`](docs/topology.md) and [`examples/topology-multicloud/`](examples/topology-multicloud/)).
